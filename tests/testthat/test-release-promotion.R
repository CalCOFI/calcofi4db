...
ALL_PRESENT <- "catalog.json|metadata.json|relationships.json|datasets.json|taxa.json|measurements.json|eml/"   # datasets.json since 4.1.0, eml/ since 4.2.0, taxa.json since 4.9.0, measurements.json since the measurements catalog
