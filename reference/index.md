...
- [`check_cruise_coverage()`](https://calcofi.io/calcofi4db/reference/check_cruise_coverage.md)
  : Cruises that carry samples but no observations — the silent-loss
  guard
...
- [`CC_DEPTH_MAX_M`](https://calcofi.io/calcofi4db/reference/CC_DEPTH_MAX_M.md)
...
- [`CC_RELEASE_PREFIX`](https://calcofi.io/calcofi4db/reference/CC_RELEASE_PREFIX.md)
...
- [`assert_measurements_catalog()`](https://calcofi.io/calcofi4db/reference/assert_measurements_catalog.md)
  ...
  Stop on any failing check from
...
- [`check_seafloor_nulls()`](https://calcofi.io/calcofi4db/reference/check_seafloor_nulls.md)
  :
...
- [`declare_measurement_bounds()`](https://calcofi.io/calcofi4db/reference/declare_measurement_bounds.md)
  ...
  Declare `valid_min` / `valid_max` on measurement types that already
  exist
...
- [`ensure_taxon_lineage()`](https://calcofi.io/calcofi4db/reference/ensure_taxon_lineage.md)
  ...
  Materialize the WoRMS/ITIS lineage
  [`build_taxon_reference()`](https://calcofi.io/calcofi4db/reference/build_taxon_reference.md)
  reads
...
- [`fetch_taxon_xref()`](https://calcofi.io/calcofi4db/reference/fetch_taxon_xref.md)
  : Fetch (and cache) the WoRMS \<-\> ITIS cross-reference for a set of
  taxa
...
- [`match_cruise_by_track()`](https://calcofi.io/calcofi4db/reference/match_cruise_by_track.md)
  : Match Records to a Cruise by Space-Time Proximity to an
  Occupied-Station Track
...
- [`recheck_pending_urls()`](https://calcofi.io/calcofi4db/reference/recheck_pending_urls.md)
  ...
  Re-probe the URLs
  [`check_dataset_catalog()`](https://calcofi.io/calcofi4db/reference/check_dataset_catalog.md)
  left pending, after their upload
